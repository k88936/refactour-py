...
use stdout to recieve response of app:
...
multiprocessing because it provides seperate memory space like subprocess, and is more controlable. and redricting stdio
